                                    ...
                                    {directMessages.slice(0, 4).map(({ conversation, otherMember }) => (
                                        <div key={conversation._id} className="flex flex-col items-center space-y-2">
                                            ...
                                            <div className="flex space-x-2">
                                                <Button size="sm" variant="outline" onClick={() => console.log("video call ")} className="border-blue-600 text-blue-600 hover:bg-blue-100 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900">
                                                    <Video className="h-4 w-4" />
                                                </Button>
                                                <Button size="sm" variant="outline" onClick={() => console.log("audio call ")} className="border-blue-600 text-blue-600 hover:bg-blue-100 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900">
